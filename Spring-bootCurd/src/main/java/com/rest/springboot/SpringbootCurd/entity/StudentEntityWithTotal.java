...
public class StudentEntityWithTotal implements Comparable<StudentEntityWithTotal>{
	...
	public StudentEntityWithTotal(Long id, String name, float englishMarks, float scienceMarks, float mathsMarks,
			float totalMarks) {
		super();
		this.id = id;
		this.name = name;
	...
	@Override
	public int compareTo(StudentEntityWithTotal st) {
